...
Launch [Arknights](https://arknights.wiki.gg) countdown timers using [Hourglass](https://github.com/i2van/hourglass). See [Hourglass FAQ](https://chris.dziemborowicz.com/apps/hourglass/#faq) for details.
